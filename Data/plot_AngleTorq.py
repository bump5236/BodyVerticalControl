...
plt.plot(R_pos, R_tgt_torq/l, label= "R Target Torque", lw = LINE_WIDTH)
plt.plot(R_pos, R_torq/l, label= "R Current Torque", lw = LINE_WIDTH)
# plt.xlim(T_MIN, T_MAX)
plt.legend()

plt.figure(figsize=(10,8))
plt.plot(run_ang+5, run_tgt_torq/0.5*0.4/l, label= "Run Target Torque", lw = LINE_WIDTH)
plt.plot(L_pos, L_tgt_torq/l, label= "L Target Torque", lw = LINE_WIDTH)
plt.plot(L_pos, L_torq/l, label= "L Current Torque", lw = LINE_WIDTH)
# plt.xlim(T_MIN, T_MAX)
plt.legend()
